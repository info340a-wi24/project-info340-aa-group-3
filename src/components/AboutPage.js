  ...
  return (
    <div id="about">
        ...
        <p class="textbox">
            ...
            <cite><a target="_blank" href="https://www.nytimes.com/interactive/2020/07/03/us/george-floyd-protests-crowd-size.html">(Buchanan et al., 2020)</a></cite>. 
        ...
        <p class="textbox">
            ...
            <cite><a target="_blank" href="https://restofworld.org/2021/how-governments-go-after-protesters-using-social-media/">(Cortés, 2021)</a></cite>. 
            To better empower the public to speak up in meaningful ways, a new solution is required.
        </p>
        <p class="textbox">Protest Hub is created to solve just that.</p>
    </div>
  );
}